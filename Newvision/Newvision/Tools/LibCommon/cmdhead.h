...
#define CGI_IESET_SDCARD			0x6029
...
#define CGI_HKWS_SDCARD_LIST  0x6055

#define CGI_TALK_OPEN_CLOSE             0x100002


#define CGI_P2P_UPGRADE_FIRMWARE  0x60C0
#define CGI_P2P_FIRMWARE_TRANSFRE_START  0x60C1
#define CGI_P2P_FIRMWARE_TRANSFRE_DATA  0x60C2
#define CGI_P2P_FIRMWARE_TRANSFRE_END  0x60C3
//视频参数
...
typedef struct _stBcastParam
{
	...
	char            dwDeviceID[24]; 		//platform deviceid
    char            dwApiLisense[8];
...
#define CGI_COMMON_JASON                  0x80a0
#define CGI_COMMON_JASON_CHECK                  0x80a1
#endif
