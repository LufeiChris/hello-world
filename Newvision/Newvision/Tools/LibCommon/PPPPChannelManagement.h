...
public:
    ...
    int PPPPSetSystemParams(const char * szDID,int type,char * msg,int len);
   ...
   int PPPPGetSDCardRecordFileList(char *szDID, int startTime, int endTime);
    ...
    int SetSnapChatDelegate(char *szDID,id delegate);
    int SetAlarmChannelDelegate(char *szDID,id delegate);
